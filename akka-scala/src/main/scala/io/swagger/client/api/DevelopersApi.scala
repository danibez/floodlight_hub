/**
 * microServAPI
 * API documentation for Microservice course at CIn-UFPE 2020.1 class
 *
...
object DevelopersApi {
  ...
  def searchInventory(searchString: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None): ApiRequest[Seq[InventoryItem]] =
    ApiRequest[Seq[InventoryItem]](ApiMethods.GET, "https://virtserver.swaggerhub.com/Cin-UFPE/microServAPI/1.0.0", "/inventory", "application/json")
